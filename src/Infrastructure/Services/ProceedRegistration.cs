...
{
    public class ProceedRegistrationUser : IProceedRegistration
    {
        private readonly AppDbContext _db;
        private readonly AppIdentityDbContext _identityDb;
        private readonly IMapper _mapper;
        
        public ProceedRegistrationUser(AppDbContext db, IMapper mapper, AppIdentityDbContext identityDb)
        {
            _db = db;
            _mapper = mapper;
