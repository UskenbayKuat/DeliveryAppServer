    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Route>().HasData(
                new Route(){Id = 1, StartCityId = 1, FinishCityId = 2, Price = (decimal)1000},
                new Route(){Id = 2, StartCityId = 1, FinishCityId = 3, Price = (decimal)2000},
                new Route(){Id = 3, StartCityId = 2, FinishCityId = 1, Price = (decimal)1000},
                new Route(){Id = 4, StartCityId = 3, FinishCityId = 1, Price = (decimal)2000},
                new Route(){Id = 5, StartCityId = 2, FinishCityId = 3, Price = (decimal)2000},
                new Route(){Id = 6, StartCityId = 3, FinishCityId = 2, Price = (decimal)2000}
                );
